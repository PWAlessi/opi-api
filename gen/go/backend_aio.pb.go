...
type AioRemoteController struct {
	...
	Handle    *v1.ObjectKey `protobuf:"bytes,1,opt,name=handle,proto3" json:"handle,omitempty"`
...
func (x *AioRemoteController) GetHandle() *v1.ObjectKey {
	if x != nil {
		return x.Handle
	}
	return nil
...
func (x *AioRemoteController) GetUuid() *v1.Uuid {
	if x != nil {
		return x.Uuid
	}
	return nil
...
func (x *AioRemoteControllerDeleteRequest) GetHandle() *v1.ObjectKey {
	if x != nil {
		return x.Handle
	}
	return nil
...
func (x *AioRemoteControllerGetRequest) GetHandle() *v1.ObjectKey {
	if x != nil {
		return x.Handle
	}
	return nil
...
func (x *AioRemoteControllerGetStatsRequest) GetHandle() *v1.ObjectKey {
	if x != nil {
		return x.Handle
	}
	return nil
...
func (x *AioRemoteControllerStatsRequest) GetHandle() *v1.ObjectKey {
	if x != nil {
		return x.Handle
	}
	return nil
...
func (x *AioRemoteControllerStats) GetHandle() *v1.ObjectKey {
	if x != nil {
		return x.Handle
	}
	return nil
...
var file_backend_aio_proto_rawDesc = []byte{
	...
	0x5f, 0x61, 0x70, 0x69, 0x2e, 0x73, 0x74, 0x6f, 0x72, 0x61, 0x67, 0x65, 0x2e, 0x76, 0x31, 0x2e,
	0x41, 0x69, 0x6f, 0x52, 0x65, 0x6d, 0x6f, 0x74, 0x65, 0x43, 0x6f, 0x6e, 0x74, 0x72, 0x6f, 0x6c,
	0x6c, 0x65, 0x72, 0x22, 0x00, 0x42, 0x2a, 0x5a, 0x28, 0x67, 0x69, 0x74, 0x68, 0x75, 0x62, 0x2e,
...
var file_backend_aio_proto_goTypes = []interface{}{
	...
	(*v1.ObjectKey)(nil),                       // 10: opi_api.common.v1.ObjectKey
	(*v1.Uuid)(nil),                            // 11: opi_api.common.v1.Uuid
